...
impl Telemetry {
    ...
    pub fn record_verity_check(&self, passed: bool) {
        ...
        if !passed {
            self.verity_failures.fetch_add(1, Ordering::Relaxed);
        }
    }
    ...
    pub fn verity_checks(&self) -> u64 {
        self.verity_checks.load(Ordering::Relaxed)
    }
    pub fn verity_failures(&self) -> u64 {
        self.verity_failures.load(Ordering::Relaxed)
    }
